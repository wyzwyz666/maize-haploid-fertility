...
# 加载模型
model_path = '/home/wyz/python/classification-pytorch-main/cirui/logs/20241127/ep193-train_acc0.765-val_acc0.841-inresv1.pth'
classification = Classification(model_path)

# 加载数据集
data_path = '../clstestc.txt'
...
# 评估Top-1和Top-5准确率
top1_acc, top5_acc, recall, precision = evaluteTop1_5(classification, lines, metrics_out_path)
print(f'Top-1 Accuracy: {top1_acc:.4f}')
print(f'Top-5 Accuracy: {top5_acc:.4f}')

# 评估Recall
recall_acc = evaluteRecall(classification, lines, metrics_out_path)
print(f'Recall Accuracy: {recall_acc:.4f}')
